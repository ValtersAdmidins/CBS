...
public class MovieController {
	...
	public String getMovieById(@PathVariable(value = "id") Long movieId, Model model) {
	  ...
	  @PostMapping("/movies/create") public Movie createMovie(@Valid @RequestBody Movie movie) { 
...
// View sample movie
	  ...
	  @GetMapping(path = "/movies/sample") public String viewSampleMovie(Model model) {
